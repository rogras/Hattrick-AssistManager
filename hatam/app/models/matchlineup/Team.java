...
public class Team {
    ...
    @XmlElement(name = "ExperienceLevel", required = true)
    protected BigInteger experienceLevel;
    @XmlElement(name = "Lineup", required = true)
     ...
     *     
     */
    public void setExperienceLevel(BigInteger value) {
     ...
     *     
     */
    public void setLineup(Lineup value) {
        this.lineup = value;
    }
